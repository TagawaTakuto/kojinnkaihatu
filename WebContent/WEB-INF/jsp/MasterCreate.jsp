...
<body>
	...
	<div class="wrapper">
		...
		<div class="shadow">
			...
			<p class="c">
				単価:<input type="text" name="price">円 <br> <br> 在庫:<input
					type="text" name="zaiko">個 <br>
			</p>
			<br>
		</div>
		...
		<div class="shadow c">
			...
			<div class="hard_select">
				<input type="radio" name="hard_select" name="Hard" value="1"
					id="h_ch1" checked /><label for="h_ch1">PC</label> <input
					type="radio" name="hard_select" name="Hard" value="2" id="h_ch2" /><label
					for="h_ch2">PS4</label> <input type="radio" name="hard_select"
					name="Hard" value="3" id="h_ch3" /><label for="h_ch3">Swich</label>
				<input type="radio" name="hard_select" name="Hard" value="4"
		...
		<div class="c">
			<input class="search_btn" type="button"
				onclick="location.href='MasterList'" value="登録">
		</div>
	</div>
</body>
</html>